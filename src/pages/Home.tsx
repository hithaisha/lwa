          ...
          <div className="max-w-7xl mx-auto px-4 h-full flex items-center">
            <div className="text-white w-full max-w-2xl">
              <h1 className="text-3xl md:text-5xl font-bold mb-4 md:mb-6">
                Welcome to Luton Welfare Association
              </h1>
              <p className="text-lg md:text-xl mb-6 md:mb-8">
                Building stronger communities through unity, support, and
                collective action. Join us in making a difference in Luton.
              </p>
              {!user && (
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-8">
            <div className="text-center p-4">
              ...
              <h3 className="text-2xl md:text-4xl font-bold text-gray-900 mb-1 md:mb-2">
                500+
              </h3>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 md:gap-8">
            <div className="bg-white rounded-xl shadow-md overflow-hidden transition-transform hover:scale-105">
              ...
              <div className="p-4 md:p-6">
                ...
                <p className="text-sm md:text-base text-gray-600">
                  Supporting local families with essential nutrition and care
                  packages.
                </p>
              </div>
            </div>
            <div className="bg-white rounded-xl shadow-md overflow-hidden transition-transform hover:scale-105">
              ...
              <div className="p-4 md:p-6">
                ...
                <p className="text-sm md:text-base text-gray-600">
                  Providing educational support and resources to young learners.
                </p>
              </div>
            </div>
            <div className="bg-white rounded-xl shadow-md overflow-hidden transition-transform hover:scale-105 sm:col-span-2 md:col-span-1">
              ...
              <div className="p-4 md:p-6">
                ...
                <p className="text-sm md:text-base text-gray-600">
                  Bringing people together through cultural celebrations and
                  activities.
                </p>
              </div>
            </div>
      ...
      <div className="bg-blue-700 text-white py-12 md:py-16">
        <div className="max-w-7xl mx-auto px-4 text-center">
          ...
          <p className="text-lg md:text-xl mb-6 md:mb-8 text-blue-100">
            Join our community and help us create positive change in Luton.
          </p>
          {!user && (
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
            {events.map((event) => (
              <div
                key={event.id}
                className="bg-gray-50 rounded-lg p-4 md:p-6 hover:shadow-lg transition-shadow"
              >
