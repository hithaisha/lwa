  ...
  const NavLinks = () => (
    <>
      ...
      <Link
        ...
        className="w-full md:w-auto hover:text-blue-200 flex items-center space-x-1 group p-2 md:p-0"
      >
        {/* <GalleryHorizontal className="h-5 w-5 group-hover:scale-110 transition-transform" /> */}
        <span>Gallery</span>
      </Link>
      <Link
        to="/Contact"
      ...
      {user ? (
        <>
          ...
          <Link
            to="/notifications"
            className="w-full md:w-auto hover:text-blue-200 flex items-center space-x-1 group relative p-2 md:p-0"
          >
            <Bell className="h-5 w-5 group-hover:scale-110 transition-transform" />
            <span>Notifications</span>
            <div className="absolute top-0 -right-1 bg-red-500 rounded-full w-4 h-4 flex items-center justify-center text-xs">
              3
            </div>
          </Link>
          <Link
        ...
        <div className="flex flex-col md:flex-row w-full md:w-auto space-y-2 md:space-y-0 md:space-x-2">
          <Link
            to="/login"
            className="w-full md:w-auto hover:text-blue-200 px-4 py-2 rounded-lg border border-blue-400 hover:border-blue-200 transition-colors text-center"
          >
            Login
          </Link>
          <Link
            to="/register"
            className="w-full md:w-auto hover:bg-blue-600 px-4 py-2 rounded-lg bg-blue-500 transition-colors text-center"
          >
            Register
          </Link>
        </div>
